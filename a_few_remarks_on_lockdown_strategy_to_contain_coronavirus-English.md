...
2\. This situation can be observed in the Wuhan pneumonia outbreak in China, and in fact, you can see the same pattern in the SARS outbreak in 2003 and even in the MERS outbreak in Korea.

3\. The start of Lockdown, the domestic Wuhan pneumonia in China, should actually have been on January 20, 2020, the day Xi Jinping spoke publicly, not January 23, the date of Wuhan's lockdown. Similarly, the SARS epidemic lockdown is to be counted roughly from April 12, 2003, the day Hu Jintao spoke in Shenzhen. Previously, Dr. Jiang Yanyong's April 7 outburst forced the government to make public the status of SARS control efforts.
...
6\. The median incubation period for coronavirus pneumonia is five days, with a critical period two weeks after onset, either the immune system overcomes the virus or the virus conquers and causes death. A rough estimate based on current data is that death would occur three weeks after the onset if not self-cured.
...
10\. The actual situation in China was verified, with the lockdown starting on 20 January 2020, peaking around 6 February and gradually declining thereafter, and the death toll peaking on 18 February and gradually declining thereafter.SARS in 2003 and MERS in Korea in 2015 are similar, see the relevant information.

11\. This model allows for a rough prediction of the outbreak of wuhan pneumonia in Italy. In Italy, the time of Lockdown can be calculated as March 8 or March 10, with the peak of new confirmed cases occurring 17 days later, around March 26, and the peak of deaths around April 8. Two months later, around May 8, the number of new cases will be reduced to zero or close to zero.

12\. Also with reference to the total number of infections and deaths in China, the total number of infections and deaths in Italy will probably reach 120,000 to 150,000, with a terrible death toll of around 20,000 and a mortality rate that will be twice the current crude death rate of 8 per cent, or around 16 per cent.
...
23\. Let me make some of the aforementioned concepts a little clearer. Prior to the blockade, there were both frequent movements and mass gatherings of people in normal society. When there are frequent movements, there are "King of Virus" and super-spreaders who spread the virus everywhere, and when they gather on a large scale, there will be super-spreading events such as the Shincheonji Church of Jesus in Korea and the Biogen Corporation Conference in the United States.
...
26\. Following the targeted quantification, time and resources were secured for the Government, hospitals and society to deal with the existing cases, while slowing down the spread of the virus. Those infected whose disease has been identified are quarantined, either healed themselves, cured, or died, and the old virus will be completely eliminated and will not survive to spread.

27\. The virus, which has taken refuge with the asymptomatic infected people of Stay at Home, will soon face extinction as well. First, it can only infect your entire family at most, and second, it usually only lasts one, two, or three generations.
...
29\. The virus is transmitted in the family for two generations. It should be the most common scenario in which an asymptomatic infected person transmits the virus to a family member (which can be one, two or three, four or five people) after it has become infectious (five days or more, see studies), and the transmitter, the infected person, is unaware of it until one of them is sick (usually the previous generation of transmitters is first sick).
...
32\. The dominance of two-generation transmission within the family (whether one, two, three or four) determines that the peak period of infection after lockdown is after 5 + 5 = 10 days, which is a constant set by the average incubation period of 5 days for coronavirus. Unless there are really species differences between people.
...
38\. All of these time costs add up to the final determination of how long it takes from onset to diagnosis of coronavirus pneumonia. It can be long or short. Longer ones, such as in the early days of Wuhan, Wuhan City as a whole (about 7 days, with the peak of confirmed cases around February 7, excluding sudden increases due to changes in statistical methods), and shorter ones, such as in other resource-constrained provinces in the country (except Hubei), 4-5 days, with the peak of confirmed cases around February 4.

39\. Another example of short consumption times is the Republic of Korea, where the mobilization order can be counted from 18 February and reaches its peak of confirmed cases on 1 March. It can be assumed that the onset of the disease may take only three days to be confirmed. There are many reasons for the fast detection speed in Korea, which will not be expanded here.

40\. After lockdown, onset peak (10th day) + average time to diagnosis (7 days) = new peak diagnosis.
...
46\. First, look at some of the graphs. (1) New daily number of confirmed cases of coronavirus pneumonia in Korea; (2) New daily number of confirmed cases of coronavirus pneumonia in China; (3) SARS events in 2003; (4) Typical normal distribution map
...
47\. It is reasonable to assume from simple observation that the curve of the number of new infections and deaths per day from coronavirus pneumonia is a normal distribution under the lockdown measure. The apex position of this function is the 17th and 28th day of our previous estimation, respectively, and as long as the data are available for the first half of the normal distribution, it is possible to fit a constructed function to predict the data thereafter.

48\. On second thoughts, it is more appropriate to fit the prediction with a logistic function, which is itself used to describe population growth under constraints, slow at both ends, steepest in the middle, and moderating in the middle of the normal distribution curve, which does not correspond to the actual situation.
...
49\. A Python program to fit a logistic model to predict the cumulative daily confirmed cases in Italy is available at https://gist.github.com/mahavivo/646118d2c918a02202b4dba9c90ff608. Based on the current data, the number of people infected with the coronavirus pneumonia in Italy could eventually reach 150,000.

50\. I would like to discuss below the circumstances under which a country or area must be in lockdown. That is to say, at this point, you have to lock down, and if you don't actively lock down, the population will be terrified by the exponential increase in the number of infections and deaths, and thus society as a whole will be passively locked down.
...
65\. If we go back in time to 22 February, when Iran reported 28 cases and 6 deaths, can Iran control the rapid development of the plague without immediately locking down? The answer is no. According to current academic research, in the early days of the coronavirus epidemic, one death actually meant that there had been 800 infections, then six deaths, indicating that the infection had reached 4,800 by then.
...
79\. The first corollary to this is that the peak in the number of new confirmed cases in the United States will be 15 days after the lockdown date, i.e., 3 or 4 April (4 April is the lockdown date of 20 March, the date on which the lockdown was issued in New York, the most infected city).
...
83\. A more difficult question to answer below is the estimation of the total number of infections in the United States. This is difficult because the United States is still in the first half of the infection-normal curve and the trend is far from clear, unlike when the Italian data were previously estimated. Here I try to extrapolate separately in a number of ways.

84\. 1) Normal distribution curve fitting. The figure below is my own normal distribution curve fitted to the number of coronavirus infections in China, with an additional normal distribution curve fitted to the number of coronavirus deaths in China. Code available at: https://gist.github.com/mahavivo/646118d2c918a02202b4dba9c90ff608#gistcomment-3225530
...
86\. In my view, the better reference sample for the current time is Italy, although its situation is still developing, and China is the first country to have an epidemic and the early data distortions in the curve are so severe that they are of little reference value here. So let's see what the figures were for Italy and the US at the time of lockdown, respectively. Italy had a cumulative number of infections of 5,883 on March 7 lockdown and the United States had a cumulative number of confirmed infections of 12,018 on March 19 lockdown.

87\. Previously, we estimated the total number of infections in Italy to be between 120,000 and 150,000 (the result of the logistic function is 150,000), and now (26 March), in terms of data and trends, the whole figure has to be taken at a higher level, not less than 150,000, and calculated at 150,000. Then by simple analogy, the total number of infections in the US is 15 * 12018/5883 = 306,400.

88\. We have also established that the peak of infection in Italy was on 26 March and in the United States on 3 April. Now that we are 8 days away from the US peak, and the cumulative number of infections in the US is 75066, what was the cumulative number of confirmed cases in Italy 8 days before March 26, and the cumulative number of infections in Italy on March 18 was 35713. By the same analogy, the total number of infections in the US would be 15 * 79313/35713 = 333,100.
...
90\. 2) Reversal inference of the death toll. Infection occurs early, and testing is rushed forward only when it is suddenly discovered that it has been overwhelmed by the virus, which means that the first two months of infection are compressed to a month or half of testing, thus pushing up the steepness of the confirmed growth curve and causing distortion. But the gradual death curve is smooth, natural, and it responds to the "natural" process of infection, while the extent to which humans can intervene is currently limited.

91\. Thus, we can use the current number of deaths to infer the number of infections and onset of illnesses before several points in time. Previously we used the time of onset to determine the time of death, now it is reversed and the time of death is used to infer the time of onset (and the time of infection and the number of people infected at that time).
...
93\. A slight thought shows that it is in fact the reciprocal of the mortality rate. Because the US epidemic is not over now, it is not known, what we have now is the crude death rate (CDR), which is the number of existing deaths/cumulative number of confirmed cases, but based on the experience of SARS, MERS in Korea and coronavirus pneumonia in China, this figure is roughly twice the early crude death rate. --The reason for this is that the peak of death is delayed from the peak of diagnosis.
...
96\. Five days ago was the second or third day of lockdown, and based on our previous analysis, it will continue to spread within families, but it won't be long before it can run rampant, and assuming it adds up to only half the people it can infect again, then 320,000 + 160,000 = 480,000 people. That is, the total number of infections in the U.S. that we estimate based on backward extrapolation is 480,000.
...
99\. The third polynomial fitting equation: Y = a + b*X + c*X2 + d*X3 . Parameters: a = -6627.34731169232 b = 3458.64278023616 c = -403.920473891768 d = 13.208292333362 Correlation factor R2: 0.991431207821127 . When X equals 35, i.e. the cumulative number of confirmed cases on 3 April Y = 163173, multiplied by 2, the total number of infections: 326346.

100\. Quadratic polynomial fitting equation: Y = a + b*X + c*X2 + d*X3 + e*X4 . Parameters: a = 1080.75947117255 b = -1003.37528963449 c = 239.285121228531 d = -19.7564849638339 e = 0.549412954953258 Correlation coefficient R2: 0.998947741537637 . x equals 35, i.e. cumulative number of confirmed cases on 3 April Y = 201271, multiplied by 2, total number of infections: 402542.
...
105\. With the total number of infections, it is simple to estimate the total number of deaths, which can be multiplied by the death rate. The final mortality rate predicted earlier is the crude death rate * 2, which is 2.72%, then the total number of deaths would be 400,000 * 2.72% = about 10880.
...
109\. I do not intend to revise this, however, because this function fit cannot be taken too seriously, just for reference: the total number of confirmed diagnoses on 27 March is 100,000, and with six days to go before the peak on 3 April, when at least 20,000 are added to the day, then on 3 April it is 10 + 2 * 6 = 220,000, 220,000 and double = 440,000. So the previously stated 300,000-500,000 is going to move closer to the high 500,000 figure.

110\. Just two or three days later, the cumulative death toll in the United States has now risen alarmingly, jumping from 1081 (via wiki) to 2191 (via JHU), an ominous sign that could push the final death rate to as high as 4 percent in China. As mentioned above, also take the total number of infections to the high estimate of 500,000, and the final death toll would be 500,000 * 4% = 20,000. God Bless America.

111\. The text has been written at length and it is intended to end the subject for the moment. Three main questions were discussed, 1) how to estimate the new confirmed peak and deaths peak after lockdown, 2) why lockdown and when lockdown, and 3) how to predict the total number of infections and total deaths based on the predicted confirmed peak and deaths peak. With this methodology and model, the initial assessment of the plague situation in other countries and regions (e.g. Germany, UK, Indonesia, India, Egypt, Brazil, etc.) should be relatively simple to make by analogy and, of course, flexible to the specific situation.

112\. A lesson learned: the coronavirus is fierce, better exaggerated than trivialized; it is worse than you can imagine.
