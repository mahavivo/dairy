...
(10) It was mentioned above that after the normal curve is transformed into a table mountain contour line, it is difficult to quantify the duration of the plateau period of the curve and to predict the final result. On second thought, if only to give a very rough assessment, it is not impossible to give further predictions by further analysis to roughly determine the most likely duration of this plateau period.

(11) First imagine a worst-case scenario in which all previously diagnosed patients who were not hospitalized are home isolated upon arrival at the new confirmed cases vertex. Because of inadequate isolation conditions and poor safeguards, it can eventually lead to infection in the whole family.  Because the general number of family members is now about 4, then the final number of infections is (total number of infections at vertex diagnosis - number of hospitalizations) * 4, and because the percentage of hospitalizations is usually about 20%, then the final number of infections is -- total number of infections at vertex * 80% * 4.

(12) The total number of infections in Italy at our estimated peak of confirmed cases (March 26) is 80539, and the total number of deaths at the peak of death (March 27) is 9134. then the final total number of infections in Italy under the worst-case scenario could be 80539 * 80% * 4 = 257725. we cannot estimate the total number of deaths here in this way, because you cannot say that if one person dies, the whole family must die (it is limited by the age-structured distribution of family members), but if one person is infected, the whole family is likely to be infected.

(13) The total number of deaths in Italy is extrapolated from the total number of infections, which can be multiplied by the death rate. But the mortality rate is a bit more subtle in terms of what exactly it should be, with a low mortality rate in the early stages and a gradual increase in the later stages (with a delay in the death peak), which is closer to the true mortality rate, and we tentatively use the crude mortality rate of 22170/168941 = 13.12% on April 16, so that the final possible total is 257725 * 13.12% = 33821.

(14) The same approach (worst-case scenario) was used to estimate the US epidemic. The number of infections in the U.S. at the confirmed peak (April 4) was 307876, multiplied by 80%, then multiplied by 4 to get to 985203, and the latest crude mortality rate is 32868/667225 = 4.93% (JHU April 17), then the final number of deaths would be 985203 * 4.93% = 48571. note that the mortality rate here is an underestimate, and perhaps 6-8% is more appropriate (pick 8% and the final number of deaths would be 985203 * 8% = 78816), since the U.S. has just arrived near the death peak.

(15) There can be another way of thinking about this analysis. Our initial assumption that the maximum likelihood of intra-household transmission of the coronavirus after lockdown is two generations is premised on active and strict (non-household) isolation measures, which is undermined by the fact that a number of countries have, for various reasons, adopted home isolation methods.

(16) Then we now adapt home isolation using the new assumption that after lockdown, the virus is likely to spread within the family for four generations, thus pushing this high plateau forward for two more incubation periods (one incubation period of 5 days), i.e., 10 days, before returning to the descending stage of the ideal normal distribution curve after reaching the original confirmed cases peak.

(17) Four generations of transmission within the family is roughly the following, e.g., husband --> wife --> son --> daughter. Of course, it is also possible that there are larger families, grandparents, etc., but the infections of grandparents do not necessarily make up the fifth and sixth generation, as they are likely to be in the same generation as the infections of wives and sons, i.e., one person infecting two or more people (wife and grandfather). With a contemporary average of about four family members, four generations of intra-familial transmission as the maximum assumption is sufficient.

(18) To return to the estimation issue after modifying this assumption is to set the duration of the Table Mountain contour line at 10 days. The number of new confirmed cases and deaths per day for these 10 days was the same as the starting point. The vertex/peak value * 10 is the number of infections and deaths surrounded by the plateau. Together with the number of people identified by the original normal distribution curve, this is the final total number of infections and the total number of deaths.

(19) Using this approach, the number of final infections and deaths in Italy and the United States were re-estimated. The cumulative number of infections in Italy at the peak of confirmed cases (March 26) was 80539 with a peak of 6153, then the final number of infections would be 80539 * 2 + 6153 * 10 = 222608.The cumulative number of deaths in Italy at the peak of death (March 27) was 9134 with a peak of 919, then the final number of deaths would be 9134 * 2 + 919 * 10 = 27458.

(20) The cumulative number of infections in the U.S. at the peak of confirmed cases (April 4) was 307876, with a peak of 34068, then the final number of infections would be 307876 * 2 + 34068 * 10 = 956432. The cumulative number of deaths in the U.S. at the peak of deaths (April 16) was 30355, with a peak of 2141, then the final number of deaths would be 30355 * 2 + 2141 * 10 = 82120.

(21) Is it possible for the plateau period to be longer than 10 days? It is quite possible that, looking at the actual figures for Italy, the situation in Iran is even more pessimistic. However, this may not be the result of five or eight generations of virus transmission in the family, but rather of insufficient testing reagents, a chronic backlog of cases that cannot be cleared up, only serious cases being tested, a constant change from mild to serious cases, a lax social distancing policy and continued public transmission of the virus.

(22) For these situations with a plateau of more than 10 days, this factor can be increased to 15, 20, etc., if necessary, but at this point it can only be seen one step at a time and no longer-term projections can be made.

(23) Is the hypothetical worst-case scenario really the worst possible? Nor necessarily, because humans can be even more stupid and incompetent, for instance here I'm not discussing the scenario of US states taking turns and becoming the new hotspot for the epidemic.
